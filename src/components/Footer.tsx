    ...
    <footer style={{ background: "linear-gradient(to bottom, #060e1e, #030810)" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Electrical Work", "Plumbing Services", "HVAC Systems", "Renovation", "Gypsum & False Ceilings", "Fire Safety Systems"].map(s => (
                <li key={s}>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/40 text-xs leading-relaxed">
                  Industrial Area Ras Al Khor<br />Dubai, UAE — PO Box 103916
                </span>
              </li>
        ...
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-white/15 text-xs">Ras Al Khor Industrial Area, Dubai, UAE</p>
        </div>
      </div>
    </footer>
  );
