          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={inView ? { opacity: 1, x: 0 } : {}}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="https://maps.app.goo.gl/F8bHfAdKCNsrZP3H8"
            ...
            <div className="rounded-2xl overflow-hidden shadow-sm border border-gray-100 bg-gray-100" style={{ height: 380 }}>
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d231108.38379701925!2d55.1497261!3d25.1671649!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f67fb2ca54891%3A0x47490b9a5a515f70!2sSkyAims%20Technical%20Services!5e0!3m2!1sen!2s!4v1782558341820!5m2!1sen!2s"
              />
            </div>
