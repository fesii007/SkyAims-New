...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="mesh-orb-3 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full"
        style={{ background: "radial-gradient(circle, rgba(30,80,200,0.10) 0%, transparent 65%)", filter: "blur(100px)" }} />
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <motion.div variants={stagger.container} initial="hidden" animate="show">
            <motion.div variants={stagger.item}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-7 glass"
            ...
            <motion.h1 variants={stagger.item} className="font-poppins font-black hero-title text-4xl sm:text-5xl lg:text-6xl text-white leading-[1.05] mb-5">
              Dubai's Most
              <br />
            ...
            <motion.p variants={stagger.item} className="text-white/50 text-sm sm:text-base max-w-lg leading-relaxed mb-8">
              Electrical · Plumbing · HVAC · Renovation · Fire Safety · Landscape — precision-built for homes, offices, and luxury villas across the UAE.
            </motion.p>
          ...
          {/* RIGHT — premium image box (desktop only visible, collapses on mobile) */}
          <motion.div
          ...
          >
            <div className="relative w-full max-w-[480px]">
              ...
              <div className="absolute -top-4 -right-4 w-16 h-16 rounded-2xl flex flex-col items-center justify-center shadow-xl"
                style={{ background: "linear-gradient(135deg, #1E90FF, #0052c2)" }}>
                <div className="font-poppins font-black text-white text-lg leading-none">15+</div>
                <div className="text-white/70 text-[9px] font-semibold text-center leading-tight">Years<br/>UAE</div>
              </div>
            </div>
          </motion.div>
