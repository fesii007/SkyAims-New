      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 w-full">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <motion.div variants={stagger.container} initial="hidden" animate="show">
            ...
            >
              <motion.p
                className="font-poppins font-black text-2xl sm:text-3xl lg:text-4xl leading-tight tracking-wide"
                style={{
                  background: "linear-gradient(90deg, #ffffff 0%, #1E90FF 35%, #00A86B 65%, #ffffff 100%)",
              ...
              >
                WELCOME TO SKYAIMS TECHNICAL SERVICES
              </motion.p>
              {/* Underline sweep */}
              <motion.div
                className="h-[2px] mt-1 rounded-full"
                style={{ background: "linear-gradient(90deg, #1E90FF, #00A86B, #1E90FF)" }}
            ...
            <motion.p variants={stagger.item} className="text-white/50 text-sm sm:text-base max-w-lg leading-relaxed mb-8">
              Electrical · Plumbing · HVAC · Renovation · offices, and luxury villas across the UAE.
            </motion.p>
