...
const CERTS = [
  ...
  { icon: Award, title: "Quality Assured", sub: "Every Project", color: "#00A86B" },
  { icon: BadgeCheck, title: "UAE Licensed", sub: "All Trades", color: "#1E90FF" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}
          ...
          <p className="text-gray-400 text-sm max-w-md mx-auto">
            Fully compliant with Dubai Municipality and UAE authority requirements.
          </p>
        </motion.div>
